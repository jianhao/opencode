...
export const dict = {
  ...
  "settings.general.row.pluginEnabled.title": "Enabled",
  "settings.general.row.pluginAutoUpdate.title": "Plugin updates",
  "settings.general.row.pluginAutoUpdate.description": "How OpenCode updates plugins that are not pinned to a specific version",
  "settings.general.row.pluginAutoUpdate.auto": "Update automatically",
  "settings.general.row.pluginAutoUpdate.notify": "Notify only",
  "settings.general.row.pluginAutoUpdate.off": "Do not update",
  "toast.plugin.updated.title": "Plugin updated",
  "toast.plugin.updated.description": "{{plugin}} updated to {{version}}",
  "toast.plugin.updateAvailable.title": "Plugin update available",
  "toast.plugin.updateAvailable.description": "{{plugin}} {{version}} is available",
  "toast.plugin.updateAvailable.action": "Update",
  "toast.plugin.updateFailed.description": "Could not update the plugin",
}
