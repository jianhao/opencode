...
export const dict = {
  ...
  "settings.general.row.pluginEnabled.title": "启用",
  "settings.general.row.pluginAutoUpdate.title": "插件更新",
  "settings.general.row.pluginAutoUpdate.description": "未固定版本的插件如何更新",
  "settings.general.row.pluginAutoUpdate.auto": "自动更新",
  "settings.general.row.pluginAutoUpdate.notify": "仅提示",
  "settings.general.row.pluginAutoUpdate.off": "不更新",
  "toast.plugin.updated.title": "插件已更新",
  "toast.plugin.updated.description": "{{plugin}} 已更新到 {{version}}",
  "toast.plugin.updateAvailable.title": "插件有新版本",
  "toast.plugin.updateAvailable.description": "{{plugin}} 有新版本 {{version}}",
  "toast.plugin.updateAvailable.action": "更新",
  "toast.plugin.updateFailed.description": "无法更新插件",
